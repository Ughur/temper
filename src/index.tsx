...
function Root({
  ...
  function shouldDrag(el: EventTarget, isDraggingDown: boolean) {
    ...
    while (element) {
      ...
      if (element.scrollHeight > element.clientHeight) {
        if (element.role === 'dialog' || element.getAttribute('temper-drawer')) return true;
  ...
  function closeDrawer() {
    ...
    drawerRef.current.setAttribute('temper-closed-by-dragging', 'true');
    setIsOpen(false);
  ...
  return (
    <DialogPrimitive.Content
      ...
      onPointerDownOutside={(e) => {
        ...
        drawerRef.current.setAttribute('temper-clicked-outside', 'true');
        onPointerDownOutside?.(e);
      }}
      ref={composedRef}
      style={
