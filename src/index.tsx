...
export type DialogProps = {
  ...
  /**
   * When `true` the `body` doesn't get any styles assigned from Temper
   */
  ...
  /**
   * When `true` Temper will reposition inputs rather than scroll then into view if the keyboard is in the way.
  ...
  function ({ ...rest }, ref) {
    ...
    return (
      <DialogPrimitive.Overlay
        ...
        data-temper-animate={shouldAnimate?.current ? 'true' : 'false'}
        {...rest}
      />
    );
  },
...
export const Content = React.forwardRef<HTMLDivElement, ContentProps>(function (
  ...
  return (
    <DialogPrimitive.Content
      ...
      data-temper-drawer=""
      data-temper-delayed-snap-points={delayedSnapPoints ? 'true' : 'false'}
      data-temper-snap-points={isOpen && hasSnapPoints ? 'true' : 'false'}
      data-temper-custom-container={container ? 'true' : 'false'}
      data-temper-animate={shouldAnimate?.current ? 'true' : 'false'}
      {...rest}
      ref={composedRef}
      style={
...
export const Handle = React.forwardRef<HTMLDivElement, HandleProps>(function (
  ...
  return (
    <div
      ...
      ref={ref}
      data-temper-drawer-visible={isOpen ? 'true' : 'false'}
      data-temper-handle=""
      aria-hidden="true"
      {...rest}
    >
