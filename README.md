https://github.com/Ughur/temper/assets/36730035/52d2319a-9c64-4a1a-9704-15b9e3fa4177
...
Contains all parts of a dialog. Use `shouldScaleBackground` to enable background scaling, it requires an element with `[temper-drawer-wrapper]` data attribute to scale its background, [example](https://github.com/Ughur/temper/blob/main/website/src/app/layout.tsx#L13).
