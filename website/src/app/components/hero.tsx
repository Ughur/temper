    ...
    <div className="relative">
      ...
      <div className="max-w-2xl mx-auto text-center pt-64">
        <div className="flex flex-col relative">
          <h1 className="text-7xl font-semibold mb-4 relative">Temper</h1>
        ...
        <div className="flex gap-4 justify-center mt-6">
                  ...
                  <div className="mt-12">
                    <figure>
                      <blockquote className="font-serif">
                        “I especially loved the hidden details video. That was so useful, learned a lot by just reading
                        it. Can&rsquo;t wait for more course content!”
                      </blockquote>
                      <figcaption>
          ...
          <a
            href="https://github.com/Ughur/temper"
